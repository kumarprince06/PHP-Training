    ...
    <div class="row">
        <div class="form-content">
            <div class="form-items">
                <h3 class="text-center border bg-secondary text-light rounded-pill">Add Post</h3>

                <!-- Back Button -->
                <a href="<?php echo URLROOT ?>/posts/index" class="btn btn-dark m-3 ">Back</a>

                <form class="requires-validation" novalidate action="<?php echo URLROOT; ?>/posts/add" method="post">
                    <!-- Post Title Input -->
                    ...
                    <div class="form-button text-center mt-3 mx-auto">
                        <button id="submit" type="submit" class="btn btn-success ">Share Post</button>
                    </div>
                </form>
            </div>
        </div>
